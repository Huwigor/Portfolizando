...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Home</title>
        @vite('resources/js/lay-choice.js')
        @vite('resources/css/mobile/header-mobile.css')
        @vite('resources/js/carousel.js')
        @vite('resources/js/mobile/home/header/menu-mobile.js')
        @vite('resources/css/mobile/carousel-mobile.css')
        @vite('resources/js/mobile/home/header/box-user.js')
    ...
    <header id="header">
        @include('mobile.components-mobile.header-mobile')
    </header>

    <div>
        @include('mobile.components-mobile.carousel-mobile')
    </div>
